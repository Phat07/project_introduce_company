...
const SolutionDetail = () => {
  ...
  useEffect(() => {
    if (!loading && solution) {
      ...
      // Features cards animation with hover effect
      ...
      // Benefits cards animation with hover effect
                  ...
                  <Card 
                    cover={
                      <div className="h-[250px] sm:h-[400px] md:h-[600px] overflow-hidden bg-gradient-to-b from-gray-50 to-white relative">
                        <div ref={imageRef} 
                             className="absolute left-1/2 -top-[5%] sm:top-[40%] -translate-x-1/2 translate-y-0 sm:-translate-y-1/2 w-[120%] h-[120%] flex items-center justify-center scale-[0.5] sm:scale-100">
                ...
                <motion.div variants={fadeInUp}>
                  <Card className="mb-8">
                    ...
                    <Row gutter={[16, 16]} ref={benefitsRef}>
                      {solution.features.map((benefit, index) => (
                        <Col xs={24} md={12} key={index}>
